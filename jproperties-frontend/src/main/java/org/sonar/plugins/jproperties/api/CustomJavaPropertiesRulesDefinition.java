...
/**
 * Extension point to create custom rule repository for Java Properties.
 */
@ExtensionPoint
@BatchSide
public abstract class CustomJavaPropertiesRulesDefinition implements RulesDefinition {
