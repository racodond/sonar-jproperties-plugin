...
public class CustomJavaPropertiesRulesDefinitionTest {
  ...
  @Rule(
    ...
    description = "desc",
    tags = {"bug"})
  public class MyCustomRule extends org.sonar.plugins.jproperties.api.visitors.DoubleDispatchVisitor {
    @RuleProperty(
      key = "customParam",
  ...
  public static class MyCustomJavaPropertiesRulesDefinition extends CustomJavaPropertiesRulesDefinition {
